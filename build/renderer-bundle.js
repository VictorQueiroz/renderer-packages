!function(window, global) {
    ...
    }), ndModule.directive("ndHide", function(animate) {
        return {
            multiElement: !0,
    ...
    var events = "click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "), forceAsyncEvents = {
        blur: !0,
        focus: !0
    };
                ...
                compile: function($element, attr) {
                    ...
                    return function(scope, element) {
                        element.addEventListener(eventName, function(event) {
                            ...
                            forceAsyncEvents[eventName] && rootScope.phase ? timeout(callback, 0) : scope.apply(callback);
                        });
                    };
                }
            };
